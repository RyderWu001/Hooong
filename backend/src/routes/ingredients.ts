...
router.put('/batches/:batchId', requireAuth, requireRole('ADMIN', 'LAB_STAFF'), async (req, res) => {
  const {
    batchNo, supplierBatch, mfgDate, expiryDate,
    arrivalDate, warehousingDate, usageDate, usageQuantity, remainingQty,
    openedDate, openedExpiry,
